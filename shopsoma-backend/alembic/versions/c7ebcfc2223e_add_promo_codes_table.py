...
def upgrade() -> None:
    ...
    discount_type_enum = postgresql.ENUM('PERCENTAGE', 'FIXED_AMOUNT', name='discounttype')
    ...
    sa.Column('discount_type', postgresql.ENUM('PERCENTAGE', 'FIXED_AMOUNT', name='discounttype', create_type=False), nullable=False),
