...
class ProductBase(BaseModel):
    ...
    weight_kg: Optional[Decimal] = Field(None, gt=0, le=9999999.999, description="Packed product weight in kilograms")
    length_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999, description="Packed product length in centimeters")
    width_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999, description="Packed product width in centimeters")
    height_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999, description="Packed product height in centimeters")
...
class ProductUpdate(BaseModel):
    ...
    weight_kg: Optional[Decimal] = Field(None, gt=0, le=9999999.999)
    length_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999)
    width_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999)
    height_cm: Optional[Decimal] = Field(None, gt=0, le=9999999.999)
