    ...
    <footer className="bg-gray-100 text-gray-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-gray-900 text-sm font-semibold mb-3">Shop</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link to={ROUTES.PRODUCTS} className="hover:text-gray-900 transition-colors">
                  All Products
                </Link>
              </li>
              <li>
                <Link to="/new" className="hover:text-gray-900 transition-colors">
                  New Arrivals
                </Link>
              </li>
              <li>
                <Link to="/collections" className="hover:text-gray-900 transition-colors">
                  Collections
                </Link>
              </li>
              <li>
          ...
          {/* Support */}
          <div>
            <h3 className="text-gray-900 text-sm font-semibold mb-3">Support</h3>
            <ul className="space-y-2 text-sm">
              <li>
