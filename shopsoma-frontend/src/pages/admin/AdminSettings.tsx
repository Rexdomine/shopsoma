...
export default function AdminSettings() {
  ...
  const switchCategory = (next: string) => { if (next === category) return; if (dirty && !window.confirm('You have unsaved edits. Switch category and discard them?')) return; discardManualRatesRef.current?.(); setCategory(next); };
