...
export default function AdminSettings() {
  ...
  const dirty = hasChanges || payoutHoldChanged || commissionChanged || applyCommissionToExisting || featuredRotationChanged;
  ...
  const switchCategory = (next: string) => { if (next === category) return; if (dirty && !window.confirm('You have unsaved edits. Switch category and discard them?')) return; setCategory(next); };
