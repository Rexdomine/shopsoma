              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-full border border-gray-200 px-4 py-3 pr-12 text-sm font-semibold text-gray-700 bg-white appearance-none focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition cursor-pointer"
                    style={{
                      backgroundImage:
